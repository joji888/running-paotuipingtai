        ...
        <van-popup v-model="detailsShow" style="width: 100%;height: 100%;">
            <div style="display: flex;align-items: center;flex-direction: column;padding-top: 10px;">
                ...
                <div class="oUser2">
                    ...
                    />
                    <span class="oUserText">{{order.user.uRole}}</span>
                </div>
                <div style="width: 85%;">
...
<!--        发布订单弹出框-->
        <van-popup v-model="issueShow" style="width: 100%;height: 100%;">
            <div style="display: flex;align-items: center;flex-direction: column;padding-top: 10px;">
                ...
                <van-form>
                    ...
                    <!-- 允许输入正整数，调起纯数字键盘 -->
                    <van-field v-model="addOrder.oPrice" type="digit" label="预计价格" readonly />
        ...
        <van-list
                ...
                @load="listAdd"
        >
            <van-cell v-for="item in list" :key="item.uId" @click="onDetails(item)">
        ...
        methods:{
            ...
            onLoad(){//初始化函数
                ...
                this.$http.get("/order",{
                    ...
                    console.log(res.data.data.body.content[0]);
                    ...
                    for (let i=0;i<typeList.length;i++){
                        ...
                        for (let j=0;j<typeList[i].orderTypeSons.length;j++){
                            children.push({
                                ...
                                tsPrice: typeList[i].orderTypeSons[j].tsPrice
                            })
                        }
                        options2.push({
            ...
            onTypeOk(res){
                ...
                this.addOrder.oPrice=res.selectedOptions[1].tsPrice;
            ...
            addOrderFonc(){
                ...
                console.log(this.addOrder.oEndTime);
