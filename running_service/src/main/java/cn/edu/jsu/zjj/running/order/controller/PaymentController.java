...
import cn.edu.jsu.zjj.running.utils.PayMentConig;
...
public class PaymentController {
    ...
    @GetMapping("/payPage/{money}")
    public void showPayment(@PathVariable("money") Integer money,HttpServletRequest request, HttpServletResponse
            response) {
        ...
        //订单名称，必填
        String subject = "跑腿订单支付";
        //商户订单号，商户网站订单系统中唯一订单号，必填
        String out_trade_no = UUID.randomUUID().toString();
        //付款金额，必填 ShopName
        String total_amount = money+"";
        //商品描述，可空
        String body = "跑腿订单支付页面";
